...
.PHONY: test
test: node_test playwright_smoke
...
.PHONY: postcreate
postcreate: deps_install playwright_smoke
...
.PHONY: playwright_smoke
playwright_smoke: ./node_modules/.package-lock.json ./package.json ./package-lock.json
